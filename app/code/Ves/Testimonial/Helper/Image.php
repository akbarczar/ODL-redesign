...
class Image extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     * @return string
     */
    public function getImg($product, $h, $imgVersion='image', $file=null, $w=300)
    {
        if ($h <= 0) {
