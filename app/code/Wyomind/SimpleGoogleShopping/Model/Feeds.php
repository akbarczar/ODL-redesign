...
class Feeds extends \Magento\Framework\Model\AbstractModel
{
    ...
    public $requirementsHelper = null;
    /**
    ...
    public function __construct(
        ...
        \Wyomind\SimpleGoogleShopping\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory,
        ...
        /** @delegation off */
        \Wyomind\SimpleGoogleShopping\Model\ResourceModel\TaxClassFactory $taxClassResourceModelFactory,
        \Wyomind\SimpleGoogleShopping\Model\ResourceModel\ImagesFactory $imagesResourceModelFactory,
        \Wyomind\SimpleGoogleShopping\Model\ResourceModel\InventoryStockFactory $inventoryStockResourceModelFactory,
        /** @delegation off */
    ...
    public function generateXml($request = null, $report = false)
    {
        try {
            ...
            $this->progressHelper->log(">> START PROCESS FOR '" . strtoupper((string) $this->getSimplegoogleshoppingTitle()) . "'", !$this->isPreview);
...
";
            ...
            switch ($this->urlRewrites) {
                case \Wyomind\SimpleGoogleShopping\Model\Config\UrlRewrite::PRODUCT_URL:
                    ...
                    $notLike = " AND url.entity_id = e.entity_id";
                    $concat = "MAX";
                    break;
                default:
