 ...
 */
namespace Wyomind\Framework\Helper;  class Delegate extends \Wyomind\Framework\Helper\License {public $x568c4=null;public $xf02c2=null;public $x4a897=null; const VERSION = "\67.\62.\61\62"; public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Framework\App\Helper\Context $context) { parent::__construct($objectManager, $context); $this->constructor($this, func_get_args(), __CLASS__); } protected function getDelegation() { ${$this->x4a897->x9f->xe2} = "\\"; return [ ]; } }