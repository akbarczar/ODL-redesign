        ...
        )
    {
        ...
        if ($isEnabled) {
           ...
           // return $result . '<a class="weltpixel-quickview '.$buttonStyle.'" data-quickview-url=' . $productUrl . ' href="javascript:void(0);"><span>' . __("Quickview") . '</span></a>';
            return $result . '<div class="secondary-actions-wrapper add-to-links" data-role="add-to-links"><a href="javascript:void(0);" data-quickview-url="' . $productUrl . '" class="weltpixel-quickview ' . $buttonStyle . '" title="Quickview"><i class="meigee-icon-quickview"></i><span>' . __("Quick view") . '</span></a></div>';
